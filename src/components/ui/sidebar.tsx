  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group peer hidden h-svh w-[--sidebar-width] flex-col text-sidebar-foreground transition-[width] duration-200 ease-linear md:flex sticky top-0 z-20 border-r bg-sidebar",
